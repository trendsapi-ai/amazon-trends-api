"""trendsapi-amazon - Trends API client with source preset to `amazon`.
...
class TrendsAPI(_TrendsAPI):
    """Sync client. Keyword-first helpers default to `amazon`."""
...
class AsyncTrendsAPI(_AsyncTrendsAPI):
    """Async client. Keyword-first helpers default to `amazon`."""
